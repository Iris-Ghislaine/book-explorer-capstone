// Import API function and shared favorites
...
// Updated render: Now takes books param (from API)
...
// Add to favorites: Unchanged, but now works with API books (use title as fallback ID if no API id)
...
// Search handler: Attached to form submit
...
// Initial fetch and render: Async on load
document.addEventListener('DOMContentLoaded', async () => {
    console.log('DOM loaded, fetching books...');
    const books = await fetchBooks('popular'); // Default query
    currentBooks = books;
    renderHomepageBooks(books);
