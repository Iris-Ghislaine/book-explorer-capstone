const homepageBooks = [
    ...
    { 
        ...
        cover: '/img/B_5.jpg',
        description: 'A shy newcomer navigates high school drama, friendships, and self-discovery in this charming graphic novel about finding your place in the world.'
    },
    { 
        id: 5, 
        ...
        author: 'Lily Adellea', 
        cover: '/img/B_3.jpg',
        description: 'In a kingdom of broken promises, a warrior princess must confront her past to forge a new path amid betrayal, magic, and forbidden romance.'
    },
    { 
        id: 6, 
        ...
        author: 'Joanne Levy', 
        cover: '/img/B_6.jpg',
        description: 'A young girl faces the challenges of camp life and budding crushes, learning that even on cloudy days, joy and connection can break through.'
    },
    { 
        id: 7, 
        title: 'Her Blue Sky', 
        ...
        cover: '/img/B_8.jpg',
        description: 'Twin sisters in a quiet town grapple with dreams, regrets, and a mysterious visitor from the past in this poignant anime-inspired story of growth.'
    },
    { 
        id: 8, 
        title: 'Lightfall', 
        author: 'Tim Probert', 
        cover: '/img/B_7.jpg',
        description: 'Delving deeper into the shadowy realms, heroes uncover ancient secrets and face trials that test the limits of courage and friendship.'
    }
];
// Render homepage books 
export function renderHomepageBooks(books = homepageBooks) {
    ...
    grid.innerHTML = books.map(book => `
        <div class="bg-white shadow-md rounded-lg p-4" data-book-id="${book.id}">
            ...
            <button class="add-fav mt-4 bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700">Add to Favorites</button>
        </div>
    `).join('');
}
// Add to favorites
export function addToFavorites(book) {
    // Simulate adding to favorites data
    console.log('Added:', book);
    alert(`${book.title} added to favorites!`); // Replace with real add later
}
// Event for add buttons
